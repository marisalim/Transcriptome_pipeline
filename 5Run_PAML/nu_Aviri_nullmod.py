...
#FOR RERUNS:
alignmentfiles_null = ['/pylon1/bi4iflp/mlim/Run_codeml_nudna/phylipforpaml/ENSTGUP00000002255.phylip','/pylon1/bi4iflp/mlim/Run_codeml_nudna/phylipforpaml/ENSTGUP00000011391.phylip',
'/pylon1/bi4iflp/mlim/Run_codeml_nudna/phylipforpaml/ENSTGUP00000011747.phylip']

# Choose start values
kappa_starts = [0, 0.05, 0.2, 5, 11, 15] # range of start values for kappa
...
#		file_null = aname.split('.')[0]
		...
		while notconverged:
			...
			if 'check convergence..' in open(file_null + '_Aviri_modAnull.out').read(): 
				...
				os.system('mv ' + file_null + '_Aviri_modAnull.out /pylon1/bi4iflp/mlim/Run_codeml_nudna/nuDNA_codemlout_Aviri/Aviriout_nu')
				print 'Success!!!', file_null, ' moved to Aviriout_nu directory'
				print '----------------------------------------------------------------'
				break
...
os.system('grep lnL /pylon1/bi4iflp/mlim/Run_codeml_nudna/nuDNA_codemlout_Aviri/Aviriout_nu/*modAnull.out | awk \'{print $1"\t"$5}\' > /pylon1/bi4iflp/mlim/Run_codeml_nudna/nu_Aviri_lnL_null.txt')
