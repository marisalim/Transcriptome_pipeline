	...
	if '.phylip' in aname:
		...
		while notconverged:
			...
			if 'check convergence..' in open(file_null + '_Cviol_modAnull.out').read(): 
				...
				os.system('mv ' + file_null + '_Cviol_modAnull.out /pylon1/bi4iflp/mlim/Run_codeml_mtdna/mtDNA_codemlout_Cviol/Cviolout')
				print 'Success!!!', file_null, ' moved to Cviolout directory'
				print '----------------------------------------------------------------'
				break
	...
	if '.phylip' in aname:
		...
		while notconverged:
			...
			if 'check convergence..' in open(file_pos + '_Cviol_modApos.out').read():
				...
				os.system('mv ' + file_pos + '_Cviol_modApos.out /pylon1/bi4iflp/mlim/Run_codeml_mtdna/mtDNA_codemlout_Cviol/Cviolout')
				print 'Success!!!', file_pos, ' moved to Cviolout directory'
				print '----------------------------------------------------------------'
				break
...
os.system('grep lnL /pylon1/bi4iflp/mlim/Run_codeml_mtdna/mtDNA_codemlout_Cviol/Cviolout/*modAnull.out | awk \'{print $1"\t"$5}\' > /pylon1/bi4iflp/mlim/Run_codeml_mtdna/Cviol_lnL_null.txt')
os.system('grep lnL /pylon1/bi4iflp/mlim/Run_codeml_mtdna/mtDNA_codemlout_Cviol/Cviolout/*pos.out | awk \'{print $1"\t"$5}\' > /pylon1/bi4iflp/mlim/Run_codeml_mtdna/Cviol_lnL_pos.txt')
