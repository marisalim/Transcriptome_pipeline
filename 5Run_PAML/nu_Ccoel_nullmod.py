...
#FOR RERUNS:
alignmentfiles_null = ['/pylon1/bi4iflp/mlim/Run_codeml_nudna/phylipforpaml/ENSTGUP00000001110.phylip',
'/pylon1/bi4iflp/mlim/Run_codeml_nudna/phylipforpaml/ENSTGUP00000017653.phylip']
...
#		file_null = aname.split('.')[0]
		...
		while notconverged:
			...
			if 'check convergence..' in open(file_null + '_Ccoel_modAnull.out').read(): 
				...
				os.system('mv ' + file_null + '_Ccoel_modAnull.out /pylon1/bi4iflp/mlim/Run_codeml_nudna/nuDNA_codemlout_Ccoel/Ccoelout_nu')
				print 'Success!!!', file_null, ' moved to Ccoelout_nu directory'
				print '----------------------------------------------------------------'
				break
...
os.system('grep lnL /pylon1/bi4iflp/mlim/Run_codeml_nudna/nuDNA_codemlout_Ccoel/Ccoelout_nu/*modAnull.out | awk \'{print $1"\t"$5}\' > /pylon1/bi4iflp/mlim/Run_codeml_nudna/nu_Ccoel_lnL_null.txt')
