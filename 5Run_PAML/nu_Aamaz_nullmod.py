...
'/pylon1/bi4iflp/mlim/Run_codeml_nudna/phylipforpaml/ENSTGUP00000006101.phylip',
'/pylon1/bi4iflp/mlim/Run_codeml_nudna/phylipforpaml/Hbb.phylip']

# Choose start values
kappa_starts = [0, 0.01, 0.2, 6, 10, 20] # range of start values for kappa
...
#		file_null = aname.split('.')[0]
		...
		while notconverged:
			...
			if 'check convergence..' in open(file_null + '_Aamaz_modAnull.out').read(): 
				...
				os.system('mv ' + file_null + '_Aamaz_modAnull.out /pylon1/bi4iflp/mlim/Run_codeml_nudna/nuDNA_codemlout_Aamaz/Aamazout_nu')
				print 'Success!!!', file_null, ' moved to Aamazout_nu directory'
				print '----------------------------------------------------------------'
				break
...
os.system('grep lnL /pylon1/bi4iflp/mlim/Run_codeml_nudna/nuDNA_codemlout_Aamaz/Aamazout_nu/*modAnull.out | awk \'{print $1"\t"$5}\' > /pylon1/bi4iflp/mlim/Run_codeml_nudna/nu_Aamaz_lnL_null.txt')
